  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // In a real app, we would filter questions by company ID
        // For now, we'll just show all questions
    ...
    <div className="container mx-auto p-6">
      <div className="flex flex-col md:flex-row justify-between items-start mb-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">Manage questions for your interview pools</p>
        </div>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem asChild>
                                <Link href={`/provider/questions/${question.id}`}>View details</Link>
                              </DropdownMenuItem>
                              <DropdownMenuItem asChild>
                                <Link href={`/provider/questions/${question.id}/edit`}>
