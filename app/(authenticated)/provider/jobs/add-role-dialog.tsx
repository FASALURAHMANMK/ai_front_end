...
export function AddRoleDialog({ isOpen, onClose, onAddRole }: AddRoleDialogProps) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div>
          <h3 className="text-lg font-medium">Review Job Listing</h3>
          <p className="text-sm text-muted-foreground">
            Please review the information before creating the job listing.
          </p>
        </div>
        ...
        <div className="rounded-md border p-4 space-y-3">
          ...
          <div>
            <span className="font-medium">Salary Range:</span> {salary}
          </div>
          <div>
